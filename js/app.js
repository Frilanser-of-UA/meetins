window.addEventListener('DOMContentLoaded', function () {
	let filtr = document.querySelectorAll('.form__item_active');

	[].forEach.call(filtr, function (a) {
		a.addEventListener('click', function (event) {
			event.preventDefault()
			a.classList.toggle("_checked")
		});
...
//RANGE
const priceSlider = document.querySelector('.form__range');
if (priceSlider) {
